                    ...
                    <form action="{{ route('profile.edit.post') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="layout-content-container flex flex-col max-w-[960px] flex-1">
                            ...
                            <div class="flex p-4 @container">
                                <div
                                    class="flex w-full gap-4 @[520px]:flex-row @[520px]:justify-between @[520px]:items-center">
                                    ...
                                    <label for="imageUpload"
                                        ...
                                        <input id="imageUpload" type="file" name="user_image"
                                            accept=".png, .jpeg, .jpg, .webp" class="w-full h-full" hidden>
                                    </label>
                                </div>
                            </div>
                            <h2
                                    ...
                                    @if ($hobbies !== '')
                                        {{-- @foreach ($hobbiesArray as $hobby)
                                            <span
                                                ...
                                                {{ $hobby }}
                                                <button
                                                    class="group relative -mr-1 h-3.5 w-3.5 rounded-sm hover:bg-primary/20"
                                                    type="button">
                                                    <span
